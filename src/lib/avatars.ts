// Avatar art shown in the Create Table modal's picker and rendered at each
// seat (Seat.tsx). Add more entries here (id + label + a webp in
// public/images/avatars/) to expand the picker — no other wiring needed.
